...
The SQL standard allows creating indexes on demand. When a user issues a {\sc {Create Index}} 
...
independently of the base table) and local (co-sharded with the base table). 
In the latter case, the index building transaction is pushed into a coprocessor; this 
...
{\inred{Normally, the SI model enforces read-your-own-writes semantics. However, in this case}}
