...
{\sys\/} provides  \emph{snapshot isolation (SI)}~\cite{DBLP:conf/sigmod/BerensonBGMOO95},
...
The fast path requires minor extensions to the underlying 
data store. 
...
This improves the latency of short transactions 
