...
with the thrust into new interactive domains like social networks~\cite{chatter},  messaging~\cite{Borthakur:2011} 
and algorithmic trading~\cite{opentsdb} latency becomes essential;   
...
% Drum roll 
This paper reports on our recent extensions and improvements of Apache Incubator Omid~\cite{omid},
...
\inred{while preserving Omid's applicability to multi-tenancy settings}.  
