...
\inred{The latter employs 
transaction processing services provided by either Omid~\cite{Omid2017}\footnote{\url{https://issues.apache.org/jira/browse/PHOENIX-3623}}
or Tephra\cite{tephra}}. These systems develop transaction processing engines on top of existing persistent 
