...
\Yoni{MAybe add a figure of omidLL architecture vs omid 2?}
...
\Yoni{I think this is confusing. Does centrelized mean only one entity has access to it, or does it mean the table is not distributed?}
\begin{table}[htb]
...
\sys				& {\bf D} 	& {\bf C} & commit & \Yoni{yes?! I dont think so}\\
%\hline
\end{tabular}
}
