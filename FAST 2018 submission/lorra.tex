...
In \sys, we instead adopt Omid's centralized conflict detection mechanism, which eliminates the need for locking objects,
and is extremely scalable~\cite{Omid2017}. 
