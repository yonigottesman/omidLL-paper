...
we made in Omid~\cite{omid}\footnote{\small{\url{https://issues.apache.org/jira/browse/OMID-82} summarizes the new features' development process.}}, an open source transaction manager for HBase, to power 
