...
\remove{
% OLD SI definition - no relaxation of RTO
More precisely, 
...
Note that under SI (and its variants), two concurrent transactions conflict only if they both \emph{update} the same item.  
