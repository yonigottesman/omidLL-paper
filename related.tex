...
transactions with native atomic operations, rather than on a unified FP API. It suggests
a less efficient implementation as native operation could casue starvation of long transactions.  
