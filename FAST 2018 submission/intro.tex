...
whereas \sys's remains stable until we generate a higher load ($\sim\!\!500$K tps)
...
This comes at the cost of a minor (less than 15\%) \Yoni{25\% fo high tx} negative impact on longer transactions. 
