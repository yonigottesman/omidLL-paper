...
\begin{figure*}[]
  ...
  \begin{subfigure}[t]{0.4\textwidth}
	\includegraphics[width=\textwidth]{figs/lorratx1read.pdf}
	\caption[]{Single read transactions}
    \label{fig:latency:lorra1read}
  \end{subfigure} \\

    \begin{subfigure}[t]{0.4\textwidth}
	\includegraphics[width=\textwidth]{figs/lorratx5.pdf}
  ...
  \begin{subfigure}[t]{0.4\textwidth}
	\includegraphics[width=\textwidth]{figs/lorratx10.pdf}
...
Another machine created load on the system by running threads that generated random transactions towards Hbase and the TSO. To create further load on th TSO, we

Transaction size had a zipfian distribution from 1 to 10.
