...
In Section~\ref{sec:context} we outlined the design space of existing TPSs that suppport SI semantics via the general paradigm outlined in Algorithm~\ref{alg:schema}. 
...
\Idit{I'm not sure we need this subsection -- anything to say beyond what is in Section~\ref{sec:alg}? Something about the HBase implementation?}
