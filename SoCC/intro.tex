...
in web-scale applications started from specific use cases like real-time content indexing for 
search~\cite{Percolator2010, Omid2017} but quickly expanded to full-scale SQL-compliant OLTP 
and online analytics~\cite{Phoenix, F1-2013}.
