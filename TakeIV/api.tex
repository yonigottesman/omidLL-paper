...
The TPS architecture considered in this paper consists of an underlying data store, a client
library, and transactional managers, as depicted in Figure~\ref{fig:components}.
Section~\ref{ssec:data-model} describes the data model and API of the underlying data store, and  Section~\ref{ssec:transactions} defines transaction semantics provided by the TPS client library. 
