...
\Procedure{commit}{$ts_r$, write-set, leader}
...
\sys's TM is based on Omid's TM, and has the same functionality except that it does not write commit entries (since this is done by the clients at post-commit).
