...
%{\inred{In particular, transaction processing systems can no more trade latency for scale as they used to~\cite{Omid2017}. }}
...
% describes functionality extensions for SQL support.  
...
\remove{
\item {\inred {{\em Design space\/}. 
We explore the design choices of transaction processing engines 
