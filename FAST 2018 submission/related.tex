...
uses centralized conflict detection. This eliminates the need to modify HBase to support locking
facilitating committing the improved system back to the production version of Omid. 
