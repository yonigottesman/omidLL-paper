...
We believe they will become instrumental for modern cloud-bases, large-scale, 
latency-sensitive services. For example, the Phoenix OLTP system that uses Omid 
is designed to harness 10K nodes, and  process real-time queries and updates 
within 10ms.}}
