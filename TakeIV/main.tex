...
\vldbTitle{Omid-Evolution: Fast, Scalable Transactions for Real-Time Cloud Analytics}
\vldbAuthors{Gottesman et al.}
...
\title{Omid-Evolution: \\ Fast,  Scalable Transactions for Real-Time Cloud Analytics }
...
Ohad Shacham\\
       \affaddr{Yahoo Research}
       \email{}
%\alignauthor Aran Bergman\\ %\footnotemark[2]
  %     \affaddr{Technion}\\
    %          \email{trovato@corporation.com}
%\alignauthor   Edward Bortnikov%\footnotemark[1] 
%\alignauthor Eshcar Hillel%\footnotemark[1]
%\alignauthor Idit Keidar%\footnotemark[1] \footnotemark[2]
%\alignauthor Ohad Shacham%\footnotemark[1]
...
to power 
Apache Phoenix, a cloud-grade real-time SQL analytics engine.  
...
to support 
%a variety of 
converged real-time transaction processing and analytics applications -- {\em translytics} --  
...
as part of 
%which emerged in 
the process of integrating it into Phoenix as the transaction processing backend. The centerpiece
...
\section{SQL Features} \label{sec:sql}
